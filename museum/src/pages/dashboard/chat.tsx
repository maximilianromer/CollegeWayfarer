        ...
        <div className="max-w-3xl mx-auto">
          <form onSubmit={handleSendMessage} className="relative flex flex-col gap-2">
              ...
              <div className="absolute bottom-0 left-0 right-0 flex items-center justify-between px-4 py-2 border-t bg-background/80 backdrop-blur-sm">
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    className="h-9 w-9 rounded-full p-0 border border-border/40 flex items-center justify-center bg-transparent opacity-50"
                    disabled
                    title="File attachments disabled in demo mode"
                  >
                    <PlusCircle className="h-4 w-4" />
                  </Button>
            ...
            <div className="mt-1 mb-0 text-xs text-muted-foreground text-center">
              Demo mode: Responses are prerecorded. This is not a live AI service.
            </div>
          </form>
        </div>
      </div>
